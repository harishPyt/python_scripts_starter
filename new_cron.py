...
import logging
logging.basicConfig(filename='/Users/mac/Documents/Harish_Ramani/code/scripts/python/logs/cronlog.log',level=logging.DEBUG)
...
rome2Rio = getACollection(local, 'rome2rioResponses')
